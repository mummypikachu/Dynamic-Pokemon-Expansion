...
const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
	...
	[SPECIES_BUTTERFREE] =       {{EVO_MEGA, ITEM_BEEDRILLITE, SPECIES_BUTTERFREE_MEGA, MEGA_VARIANT_STANDARD}},
	...
	[SPECIES_PIKACHU] =          {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_RAICHU_A, 0},
	...
	[SPECIES_BUTTERFREE_MEGA] =  {{EVO_GIGANTAMAX, FALSE, SPECIES_BUTTERFREE, 0}},
